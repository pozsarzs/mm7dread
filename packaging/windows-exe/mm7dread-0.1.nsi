...
Section "Translate HU" SEC02
  ...
  File "mm5dread\languages\hu\mm5dread.mo"
  File "mm5dread\languages\hu\mm5dread.po"
  SetOutPath "$INSTDIR\languages"
  File "mm5dread\languages\mm5dread.pot"
SectionEnd

Section -AdditionalIcons
  SetOutPath $INSTDIR
  CreateDirectory "$SMPROGRAMS\MM5DRead"
  CreateShortCut "$SMPROGRAMS\MM5DRead\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd

Section -Post
  WriteUninstaller "$INSTDIR\uninst.exe"
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\mm5dread.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\mm5dread.exe"
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\MM5DRead\MM5DRead.lnk"

  RMDir "$SMPROGRAMS\MM5DRead"
